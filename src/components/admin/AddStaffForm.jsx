    ...
    const fetchStations = async () => {
      try {
        ...
        if (stationList.success) {
          const listActiveStations = stationList.data.filter(
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "formBasicPasswordConfirm":
        ...
        if (value !== formData.formBasicPassword)
  ...
  const handleBlur = (event) => {
    ...
    if (name === "formBasicPassword" && formData.formBasicPasswordConfirm) {
      const confirmError = validateField(
        "formBasicPasswordConfirm",
        formData.formBasicPasswordConfirm,
      );
      setFormErrors((prevErrors) => ({
        ...prevErrors,
      ...
      <div className="form-container">
        <Form noValidate onSubmit={handleSubmit} className="add-staff-form">
          ...
          <div className="form-header">
            ...
            <h4 className="form-title">Thêm nhân viên mới</h4>
          </div>
          ...
          <div className="form-section">
            ...
            <Row className="mb-3">
              <Form.Group as={Col} md={6} controlId="formBasicName">
                <Form.Label className="form-label">Tên nhân viên</Form.Label>
                <Form.Control
                  type="text"
                  ...
                  onBlur={handleBlur}
                  isInvalid={!!formErrors.formBasicName}
                  required
                />
            ...
            <Row className="mb-3">
              <Form.Group as={Col} md={6} controlId="formBasicBirthday">
          ...
          {/* Thông tin công tác */}
          <div className="form-section">
            <h6 className="section-title">📍 Thông tin công tác</h6>
            <Row className="mb-3">
              ...
              <Form.Group as={Col} md={6} controlId="stationID">
                <Form.Label className="form-label">Trạm sạc</Form.Label>
                <Form.Select
                  name="stationID"
          ...
          {/* Tài khoản */}
          <div className="form-section">
            <h6 className="section-title">🔐 Tài khoản</h6>
            <Row className="mb-3">
              <Form.Group as={Col} md={12} controlId="formBasicEmail">
                <Form.Label className="form-label">Địa chỉ email</Form.Label>
                <Form.Control
                  type="email"
            ...
            <Row className="mb-3">
              ...
              <Form.Group as={Col} md={6} controlId="formBasicPasswordConfirm">
