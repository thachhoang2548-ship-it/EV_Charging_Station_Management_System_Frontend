  ...
  const [form, setForm] = useState(
      location.state?.profile
          ? {
            ...location.state.profile,
            dateOfBirth:
                location.state.profile.dateOfBirth || ""
          }
          : {
            email: "",
            phoneNumber: "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        toast.error(
            "Cập nhật thông tin cá nhân thất bại: " + response.message
        );
      }
    } catch (error) {
      toast.error(
        ...
        <form onSubmit={handleSubmit}>
          <div className="ep-content">
            ...
            <div className="ep-avatar-section">
              ...
              <h2 className="ep-avatar-name">
                {form.name || "Chưa có tên"}
              </h2>

              <span className="ep-avatar-role">
              Tài xế EV
            </span>
            </div>
            ...
            <div className="ep-form-card">
              <div className="ep-card-header">
              <span className="ep-card-icon blue">
                <Contact size={16} />
              </span>
              ...
              <div className="ep-grid">
                ...
                <div className="ep-field">
                  ...
                  {form.phoneNumber !==
                      (location.state?.profile?.phoneNumber || "") && (
